export default function Skills() {
  return (
    <section className="bg-[var(--section-surface,#0a0a0a)] px-8 py-24">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl">
          <p className="text-[var(--section-muted,rgba(255,255,255,0.8))] text-lg leading-relaxed mb-6">
          ...
          <p className="text-[var(--section-muted,rgba(255,255,255,0.6))] leading-relaxed mb-6">
            I can pick up any framework or language when the project needs it.
            What matters is solving the problem, not the stack.
          </p>
          <p className="text-[var(--section-muted,rgba(255,255,255,0.6))] leading-relaxed">
